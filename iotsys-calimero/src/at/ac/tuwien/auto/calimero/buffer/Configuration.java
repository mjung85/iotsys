...
public interface Configuration
{
	 ...
	 */
	public static interface NetworkFilter
	{
		/**
	 ...
	 * and it will speed up the initializing with already buffered data. Missing, but
	 ...
	 * default cache might be created to be used for subsequent caching operations. A
	 * deactivation will not remove or empty any cached contents.
	 * 
