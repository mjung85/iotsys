...
package at.ac.tuwien.auto.calimero.dptxlator;
...
public class DPTXlator2ByteFloat extends DPTXlator
{
	...
	public static final DPT DPT_WIND_SPEED =
		new DPT("9.005", "Wind speed", "0", "+670760", "m/s");
	...
	public static final DPT DPT_HUMIDITY =
		new DPT("9.007", "Humidity", "0", "+670760", "%");
	...
	public static final DPT DPT_AIRQUALITY =
		new DPT("9.008", "Air quality", "0", "+670760", "ppm");
	...
	public static final DPT DPT_VOLTAGE =
		new DPT("9.020", "Voltage", "-670760", "+670760", "mV");
	...
	public static final DPT DPT_POWER =
		new DPT("9.024", "Power", "-670760", "+670760", "kW");
	 ...
	 */
	public final float getValueFloat(int index)
	{
		return fromDPT(index);
	}
