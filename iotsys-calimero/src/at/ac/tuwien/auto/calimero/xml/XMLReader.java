...
package at.ac.tuwien.auto.calimero.xml;
...
public interface XMLReader
{
	...
	// up to give necessary support to handle Calimero XML stuff and not more.
	// If support for the XML schema for ETS configuration data is added,
	// maybe i will have a more in depth look to complete the one or other part.
