...
public interface KNXnetIPConnection
{
	...
	/**
	 * KNXnet/IP port number ({@value #IP_PORT}), used in discovery, routing, and the
	 * default port for a communication endpoint.
	 * <p>
	 */
	int IP_PORT = 3671;
	...
	/**
	 * Type for blocking mode used in {@link KNXnetIPConnection#send(CEMI,
	 ...
	 * <p>
	 */
	BlockingMode NONBLOCKING = new BlockingMode("nonblocking");
	 ...
	 * <p>
	 * Note: the method {@link KNXListener#frameReceived(at.ac.tuwien.auto.calimero2.FrameEvent)}
	 ...
	 *        behavior in increasing order<br>
	 *        {@link #NONBLOCKING}<br>
	 *        {@link #WAIT_FOR_ACK}<br>
	 *        {@link #WAIT_FOR_CON}<br>
	 * @throws KNXTimeoutException in a blocking <code>mode</code> if a timeout
	 ...
	 * control endpoint), although internal there might be used different addresses.<br>
