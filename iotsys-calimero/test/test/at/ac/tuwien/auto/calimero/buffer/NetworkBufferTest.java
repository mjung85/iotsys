...
package test.at.ac.tuwien.auto.calimero.buffer;

import java.util.Date;

import at.ac.tuwien.auto.calimero.GroupAddress;
import at.ac.tuwien.auto.calimero.buffer.CommandFilter;
import at.ac.tuwien.auto.calimero.buffer.Configuration;
import at.ac.tuwien.auto.calimero.buffer.LDataObjectQueue;
import at.ac.tuwien.auto.calimero.buffer.NetworkBuffer;
import at.ac.tuwien.auto.calimero.buffer.StateFilter;
import at.ac.tuwien.auto.calimero.buffer.LDataObjectQueue.QueueItem;
...
public class NetworkBufferTest extends TestCase
{
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#createBuffer(java.lang.String)}.
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#getBuffer(java.lang.String)}.
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#removeBuffer(java.lang.String)}.
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#createConfiguration(
	 * at.ac.tuwien.auto.calimero.link.KNXNetworkLink, java.lang.String)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#getConfiguration(
	 * at.ac.tuwien.auto.calimero.link.KNXNetworkLink)}.
	 */
	public final void testGetConfiguration()
	{
		...
		final Configuration c2 =
			NetworkBuffer.getBuffer("testGetConfig")
				.getConfiguration(c.getBufferedLink());
		assertEquals(c, c2);
	}

	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#removeConfiguration(
	 * at.ac.tuwien.auto.calimero.buffer.Configuration)}.
	 */
	public final void testRemoveConfigurationConfiguration()
	{
		final Configuration c =
			NetworkBuffer.createConfiguration(lnk, "testRemoveConfig");
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.buffer.NetworkBuffer#getAllBuffers()}.
	 */
	...
	public final void testStateBasedBuffering() throws InterruptedException, KNXException
	{
		...
		final Configuration c =
			NetworkBuffer.createConfiguration(lnk, "statebasedBuffer");
	...
	public final void testInvalidationUpdating() throws KNXException, InterruptedException
	{
		...
		final Configuration c =
			NetworkBuffer.createConfiguration(lnk, "update/invalidate");
		final DatapointMap map = new DatapointMap();
		final StateDP dp = new StateDP(group1, "group1", 0, "1.001");
		dp.add(group2, false);
		dp.add(group3, true);
