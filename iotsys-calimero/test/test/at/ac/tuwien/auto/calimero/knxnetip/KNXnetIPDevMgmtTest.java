...
import at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPConnection.BlockingMode;
...
public class KNXnetIPDevMgmtTest extends TestCase
{
	 ...
	 */
	public KNXnetIPDevMgmtTest(String name)
	{
		super(name);
	}
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPDevMgmt#send
	...
	private void doSend(CEMIDevMgmt f, BlockingMode mode, boolean positiveResponse)
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPDevMgmt#KNXnetIPDevMgmt
	 * (java.net.InetSocketAddress, java.net.InetSocketAddress, boolean)}.
	 * 
	 * @throws KNXException
	 */
	public final void testKNXnetIPDevMgmt() throws KNXException
	{
		newMgmt();
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPDevMgmt#close()}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPDevMgmt#getRemoteAddress()}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.knxnetip.KNXnetIPDevMgmt#getState()}.
	 * 
	...
	private void newMgmt() throws KNXException
	{
