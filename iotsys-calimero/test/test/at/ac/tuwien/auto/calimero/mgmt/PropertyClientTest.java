...
import at.ac.tuwien.auto.calimero.mgmt.Description;
import at.ac.tuwien.auto.calimero.mgmt.KnIPDeviceMgmtAdapter;
import at.ac.tuwien.auto.calimero.mgmt.PropertyAdapter;
import at.ac.tuwien.auto.calimero.mgmt.PropertyAdapterListener;
import at.ac.tuwien.auto.calimero.mgmt.PropertyClient;
import at.ac.tuwien.auto.calimero.mgmt.RemotePropertyServiceAdapter;
import at.ac.tuwien.auto.calimero.mgmt.PropertyClient.PID;
...
{
	private static final String PIDResource = "./src/test/properties.xml";
	private static final String PIDResourceSave = "./src/test/propertiesSaved.xml";
	...
	private final IndividualAddress remote = Util.getRouterAddress();
	 ...
	 */
	public PropertyClientTest(String name)
	{
		super(name);
	}
	...
	protected void setUp() throws Exception
	{
		...
		try {
			...
			lnk = new KNXNetworkLinkIP(KNXNetworkLinkIP.TUNNEL, null, Util.getServer(), false,
					TPSettings.TP1);
			remAdpt = new RemotePropertyServiceAdapter(lnk, remote, null, true);
			rem = new PropertyClient(remAdpt);
			ll = new PropertyListenerImpl();
			localAdpt = new KnIPDeviceMgmtAdapter(null, Util.getServer(), false, ll, true);
	 ...
	 * @throws KNXException
	 */
	public final void testPropertyClient() throws KNXException
	{
		rem.close();
		remAdpt = null;
		remAdpt = new RemotePropertyServiceAdapter(lnk, remote, null, true);
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getObjectTypeName(int)}.
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#loadDefinitions(java.lang.String)}.
	 * 
	 * @throws KNXException
	 */
	public final void testLoadDefinitions() throws KNXException
	{
		PropertyClient.loadDefinitions(PIDResource);
	}

	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#saveDefinitions(java.lang.String)}.
	 * 
	 * @throws KNXException
	 */
	public final void testSaveDefinitions() throws KNXException
	{
		PropertyClient.saveDefinitions(PIDResourceSave);
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#setResourceHandler
	 * (at.ac.tuwien.auto.calimero.mgmt.PropertyClient.ResourceHandler)}.
	 * 
	 * @throws KNXException
	 */
	public final void testSetResourceHandler() throws KNXException
	{
		PropertyClient.setResourceHandler(null);
		PropertyClient.loadDefinitions(PIDResource);
		PropertyClient.saveDefinitions(PIDResourceSave);
	}

	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#close()}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getDescription(int, int)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getDescriptionByIndex(int, int)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getProperty(int, int)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getProperty(int, int, int, int)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#getPropertyTranslated (int, int,
	 * int, int)}.
	 * 
	 * @throws KNXException
	 */
	...
	{
		final DPTXlator2ByteUnsigned t =
			(DPTXlator2ByteUnsigned) rem.getPropertyTranslated(0, 56, 1, 1);
		assertEquals(15, t.getValueUnsigned());
		final DPTXlator2ByteUnsigned t2 =
			(DPTXlator2ByteUnsigned) local.getPropertyTranslated(0, 56, 1, 1);
		assertEquals(15, t2.getValueUnsigned());
	}

	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#scanProperties(boolean)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#scanProperties(int, boolean)}.
	 * 
	 * @throws KNXException
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.mgmt.PropertyClient#setProperty (int,
	 * int, int, int, byte[])}.
	 * 
	 * @throws KNXException
	 */
	...
	private void printDesc(Description d)
	{
