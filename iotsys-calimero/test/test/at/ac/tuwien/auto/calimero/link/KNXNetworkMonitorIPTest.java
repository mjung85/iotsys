...
import at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP;
...
public class KNXNetworkMonitorIPTest extends TestCase
{
	 ...
	 */
	public KNXNetworkMonitorIPTest(String name)
	{
		super(name);
	}
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP#KNXNetworkMonitorIP
	 * (java.net.InetSocketAddress, java.net.InetSocketAddress, boolean,
	 * at.ac.tuwien.auto.calimero.link.medium.KNXMediumSettings)}.
	 * 
	 * @throws KNXException
	 */
	public final void testKNXNetworkMonitorIP() throws KNXException
	{
		if (mon != null)
			mon.close();
		try {
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP#setKNXMedium
	 * (at.ac.tuwien.auto.calimero.link.medium.KNXMediumSettings)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP#close()}.
	 * 
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP#setDecodeRawFrames (boolean)}.
	 * 
	 * @throws InterruptedException
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkMonitorIP#getName ()}.
	 * 
	 * @throws KNXException
	 */
