...
package test.at.ac.tuwien.auto.calimero.link;
...
public class KNXNetworkLinkIPTest extends TestCase
{
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#KNXNetworkLinkIP
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#KNXNetworkLinkIP(java.net.NetworkInterface, java.net.InetAddress, at.ac.tuwien.auto.calimero.link.medium.KNXMediumSettings)}.
	 * 
	 * @throws KNXException
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#addLinkListener
	 * (at.ac.tuwien.auto.calimero.link.event.NetworkLinkListener)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#setKNXMedium
	 * (at.ac.tuwien.auto.calimero.link.medium.KNXMediumSettings)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#getKNXMedium()}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#close()}.
	 * 
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#getHopCount()}.
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#removeLinkListener
	 * (at.ac.tuwien.auto.calimero.link.event.NetworkLinkListener)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#sendRequest
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#send(CEMILData, boolean)}.
	 * 
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#sendRequestWait(at.ac.tuwien.auto.calimero2.KNXAddress, at.ac.tuwien.auto.calimero.Priority, byte[])}.
	 * 
	 * @throws KNXLinkClosedException
	 * @throws KNXTimeoutException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#send(at.ac.tuwien.auto.calimero.cemi.CEMILData, boolean)}.
	 * 
	 * @throws KNXLinkClosedException
	 * @throws KNXTimeoutException
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.link.KNXNetworkLinkIP#getName()}.
	 * 
	 * @throws KNXException
	 */
