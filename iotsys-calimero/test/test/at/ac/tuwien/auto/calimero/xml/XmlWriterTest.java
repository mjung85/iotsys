...
package test.at.ac.tuwien.auto.calimero.xml;
...
import at.ac.tuwien.auto.calimero.xml.def.DefaultXMLWriter;
...
{
	private static final String file = "./src/test/write.xml";
	private Writer out;
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.xml.def.DefaultXMLWriter#DefaultXMLWriter
	 * (Writer, boolean)}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.xml.def.DefaultXMLWriter#endElement()}.
	 * 
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.xml.def.DefaultXMLWriter#endAllElements()}.
	 * 
	 * @throws IOException
	 * @throws KNXMLException
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.xml.def.DefaultXMLWriter#writeElement
	 * (String, List, String)}.
	 * 
	 * @throws IOException
	 * @throws KNXMLException
	...
	public void testWriteCommentCharData() throws KNXMLException
	{
		...
		assertEquals("\nhello XML! hello tags &lt; < &gt; > ", r.getCurrent()
			.getCharacterData());
	}

	private BufferedReader getInput(String text)
	{
		return new BufferedReader(new InputStreamReader(new ByteArrayInputStream(text
			.getBytes())));
	}
