...
import at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime;
...
public class DPTXlatorDateTimeTest extends TestCase
{
	 ...
	 */
	public DPTXlatorDateTimeTest(String name)
	{
		super(name);
	}
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#setValues
	 * (java.lang.String[])}.
	 * 
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#getAllValues()}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#setValue(java.lang.String)}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#setData(byte[], int)}.
	 */
	...
	private void dataHelperThrow(byte[] data)
	{
		try {
			t.setData(data);
			fail("invalid data");
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#getData(byte[], int)}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	private void testGetByteArrayHelper(String test, byte[] cmp)
		throws KNXFormatException
	{
		final int offset = 2;
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#getSubTypes()}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#isValid()}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#useValueFormat(boolean)}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#getValueMilliseconds()}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	private void yearHelper(int yr, int data)
	{
		t.setDate(yr, 1, 1);
	...
	private void yearHelperThrow(int yr)
	{
		try {
			yearHelper(yr, 0);
			fail("should throw");
	...
	private void dateHelper(int mth, int day, int dataMth, int dataDay)
	{
	...
	private void dateHelperThrow(int mth, int day)
	{
		try {
	...
	private void timeHelper(int hr, int min, int sec, int dataHr, int dataMin, int dataSec)
	{
	...
	private void timeHelperThrow(int hr, int min, int sec)
	{
		try {
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#setValue(long)}.
	 * @throws KNXFormatException
	 */
	...
	/**
	 * Test method for
	 * {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#isFaultyClock()}.
	 */
	...
	/**
	 * Test method for {@link at.ac.tuwien.auto.calimero.dptxlator.DPTXlatorDateTime#validate()}.
	 * 
	 * @throws KNXFormatException
	 */
	...
	private void checkTime(int hr, int min, int sec)
	{
		assertEquals(hr, t.getHour());
		assertEquals(min, t.getMinute());
		assertEquals(sec, t.getSecond());
	...
	private void assertFind(String text, String[] find)
	{
		for (int i = 0; i < find.length; ++i)
			assertTrue(text.toLowerCase().indexOf(find[i].toLowerCase()) >= 0);
	}

	private void assertFindNot(String text, String[] find)
	{
		for (int i = 0; i < find.length; ++i)
