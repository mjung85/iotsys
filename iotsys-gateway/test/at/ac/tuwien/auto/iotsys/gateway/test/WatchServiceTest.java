...
//		}
	...
	public void testMakeWatch() {
		expect().body(hasXPath("/obj[@is='obix:Watch']"))
				...
				.body(hasXPath("/obj/op[@name='delete']")).when()
				.post("/watchService/make");
	}
	...
	public void testWatchPollChanges() {
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>"
						...
						+ "		<uri val='/testDevicesWatch/switchWatch1/value' />"
						+ "		<uri val='/testDevicesWatch/switchWatch2/value' />"
						+ "	</list>" + "</obj>").post(addUri);

		// No changes yet
		expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(not(hasXPath("/obj/list/bool"))).when().post(pollUri);

		// Reset objects
		given().body("<bool val='false' />").put(
				"/testDevicesWatch/switchWatch1/value");
		given().body("<bool val='false' />").put(
				"/testDevicesWatch/switchWatch2/value");
		given().param("Content-Type", "text/plain").post(pollUri);

		// Make single change
		given().body("<bool val='true' />").put(
				"/testDevicesWatch/switchWatch1/value");
		given().expect()
				.body(hasXPath("/obj[@is='obix:WatchOut']"))
	...
	public void testWatchPollRefresh() {
		...
		expect().body(hasXPath("/obj[@is='obix:WatchOut']"))
				.body(not(hasXPath("/obj/list/bool"))).when()
				.post(pollChangesUri);
	}
	...
	public void testWatchWriteLease() {
		...
		given().body("<reltime href='lease' val='PT42S' />").expect()
				.body(hasXPath("//reltime[@name='lease' and @val='PT42S']"))
				.when().put(watchHref);
	}
	...
	public void testWatchLeaseExpiration() throws InterruptedException {
		...
		given().body("<reltime href='lease' val='PT1S' />").expect()
				.body(hasXPath("//reltime[@name='lease' and @val='PT1S']"))
				.when().put(watchHref);
	...
	public void testWatchRemove() {
		...
		expect().body(
				not(hasXPath("//bool[@href='/testDevicesWatch/switchWatch1/value']")))
	...
	public void testWatchDelete() {
		...
		expect().body(hasXPath("/obj[@is='obix:Nil']")).post(
				watchHref + "/delete");
	...
	public void testWatchAddFeed() {
		...
		given().body("<int val='1' />").put(
				"/testDevicesWatch/fanSpeedWatchAdd/fanSpeedSetpoint");
	...
	public void testWatchFeedPollRefresh() {
		...
		// initial data for feed
		given().body("<int val='1' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");
		given().body("<int val='2' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");
		given().body("<int val='3' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");
		...
		given().body("<int val='4' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");
		given().body("<int val='5' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");
		given().body("<int val='6' />").put(
				"/testDevicesWatch/fanSpeedWatchPollRefresh/fanSpeedSetpoint");

		// pollRefresh returns all events
		expect().body(hasXPath("/obj/list/feed[count(obj) = 6]"))
		...
		expect().body(not(hasXPath("/obj/list/feed"))).post(pollChangesUri);

		// pollRefresh returns all events
		expect().body(hasXPath("/obj/list/feed[count(obj) = 6]")).post(pollUri);
	}
	...
	public void testWatchFeedPollChanges() {
		...
		// initial data for feed
		given().body("<int val='1' />").put(
				"/testDevicesWatch/fanSpeedWatchPollChanges/fanSpeedSetpoint");
		given().body("<int val='2' />").put(
				"/testDevicesWatch/fanSpeedWatchPollChanges/fanSpeedSetpoint");
		given().body("<int val='3' />").put(
				"/testDevicesWatch/fanSpeedWatchPollChanges/fanSpeedSetpoint");
		...
		expect().body(hasXPath("/obj/list/feed[count(obj) = 3]"))
				.body(hasXPath("/obj/list/feed/obj[1]/int[@val='6']"))
				.body(hasXPath("/obj/list/feed/obj[2]/int[@val='5']"))
				.body(hasXPath("/obj/list/feed/obj[3]/int[@val='4']"))
				.post(pollChangesUri);
	...
	public void testWatchExtent() {
		...
		given().body("<int val='42' />").put(
				"/testDevicesWatch/fanSpeedWatchExtent/fanSpeedSetpoint");

		expect().body(
				hasXPath("/obj/list/obj[@href='/testDevicesWatch/fanSpeedWatchExtent']"))
	...
	public void testWatchHistoryFeedFiltered() {
		...
		// initial data for feed
		given().body("<int val='1' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		given().body("<int val='2' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		given().body("<int val='3' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		...
		given().body("<int val='6' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		given().body("<int val='7' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		given().body("<int val='8' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
		given().body("<int val='9' />").put(
				"/testDevicesWatch/fanSpeedWatchFilter/fanSpeedSetpoint");
	...
	public void testHistoryFeedFuture() {
		...
		String appendEvent = "<obj is='obix:HistoryAppendIn'>"
				+ "	<list name='data' of='obix:HistoryRecord'>" + "		<obj>"
				+ "			<abstime name='timestamp' val='%s'/>"
				+ "			<int name='value' val='%d'/>" + "		</obj>" + "	</list>"
				+ "</obj>";
		...
		given().contentType(ContentType.XML)
				.body("<obj is='obix:WatchIn'>"
						...
						+ "	</list>" + "</obj>").expect()
				.body(hasXPath("/obj[@is='obix:WatchOut']")).post(addUri);

		given().body(String.format(appendEvent, futureDate, 5))
				.post("/testDevicesHistory/brightnessHistoryFeedFuture/value/history/append");

		given().body("<int val='1' />").put(
				"/testDevicesHistory/brightnessHistoryFeedFuture/value");

		expect().body(hasXPath("/obj/list/feed"))
				.body(hasXPath("/obj/list/feed/obj[1]/int[@val=5]"))
		...
		given().body("<int val='3' />").put(
				"/testDevicesHistory/brightnessHistoryFeedFuture/value");
		given().body(String.format(appendEvent, futureDate, 4))
				.post("/testDevicesHistory/brightnessHistoryFeedFuture/value/history/append");
