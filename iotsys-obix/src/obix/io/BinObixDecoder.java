...
/**
 * BinObixDecoder is used to deserialize a binary encoded object into memory as a tree of Obj instances. Unlike ObixDecoder, this class doesn't support mapping contracts to predefined classes (see ObixDecoder.getUseContracts).
 * 
 * @author Brian Frank
 * @creation 1 Sep 09
 * @version $Revision$ $Date$
 */
public class BinObixDecoder extends DataInputStream
{
	 ...
	 */
	public BinObixDecoder(InputStream in) throws Exception
	{
		super(in);
	}
	...
	private Obj decode(int code) throws Exception
	{
		...
		Obj obj;
		switch (code & 0x7c)
		// mask out more and val encoding bits
		{
			case BinObix.OBJ:
				obj = new Obj();
				break;
			case BinObix.BOOL:
				obj = new Bool(readBoolVal(code));
				break;
			case BinObix.INT:
				obj = new Int(readIntVal(code));
				break;
			case BinObix.REAL:
				obj = new Real(readRealVal(code));
				break;
			case BinObix.STR:
				obj = new Str(readStrVal(code));
				break;
			case BinObix.ENUM:
				obj = new Enum(readStrVal(code));
				break;
			case BinObix.ABSTIME:
				obj = readAbstimeVal(code);
				break;
			case BinObix.RELTIME:
				obj = readReltimeVal(code);
				break;
			case BinObix.TIME:
				obj = readTimeVal(code);
				break;
			case BinObix.DATE:
				obj = readDateVal(code);
				break;
			case BinObix.URI:
				obj = new Uri(readStrVal(code));
				break;
			case BinObix.LIST:
				obj = new List();
				break;
		...
		while ((code & 0x80) != 0)
		{
			...
			// mask out more and val encoding bits
			{
				case BinObix.HAS_CHILDREN:
					hasChildren = true;
					break;
				case BinObix.NAME:
					obj.setName(readStrVal(code));
					break;
				case BinObix.HREF:
					obj.setHref(new Uri(readStrVal(code)));
					break; // TODO: need to handle like ObixDecoder
				case BinObix.IS:
					obj.setIs(readContractVal(code));
					break;
				case BinObix.STATUS_0:
				case BinObix.STATUS_1:
					obj.setStatus(readStatusVal(code));
					break;
				case BinObix.DISPLAY:
					obj.setDisplay(readStrVal(code));
					break;
				case BinObix.DISPLAY_NAME:
					obj.setDisplayName(readStrVal(code));
					break;
				case BinObix.ICON:
					obj.setIcon(new Uri(readStrVal(code)));
					break;
				case BinObix.NULL:
					obj.setNull(readBoolVal(code));
					break;
				case BinObix.WRITABLE:
					obj.setWritable(readBoolVal(code));
					break;
				case BinObix.OF:
					readOf(obj, code);
					break;
				...
				case BinObix.UNIT:
					readUnit(obj, code);
					break;
				case BinObix.PRECISION:
					readPrecision(obj, code);
					break;
				case BinObix.TZ:
					readTz(obj, code);
					break;
	...
	private void readMin(Obj obj, int code) throws IOException
	{
		...
		{
			case BinObix.INT:
				((Int) obj).setMin(readIntVal(code));
				break;
			case BinObix.REAL:
				((Real) obj).setMin(readRealVal(code));
				break;
			case BinObix.STR:
				((Str) obj).setMin((int) readIntVal(code));
				break;
			case BinObix.LIST:
				((List) obj).setMin((int) readIntVal(code));
				break;
			case BinObix.ABSTIME:
				((Abstime) obj).setMin(readAbstimeVal(code));
				break;
			case BinObix.RELTIME:
				((Reltime) obj).setMin(readReltimeVal(code));
				break;
			case BinObix.TIME:
				((Time) obj).setMin(readTimeVal(code));
				break;
			case BinObix.DATE:
				((Date) obj).setMin(readDateVal(code));
				break;
			default:
	...
	private void readMax(Obj obj, int code) throws IOException
	{
		...
		{
			case BinObix.INT:
				((Int) obj).setMax(readIntVal(code));
				break;
			case BinObix.REAL:
				((Real) obj).setMax(readRealVal(code));
				break;
			case BinObix.STR:
				((Str) obj).setMax((int) readIntVal(code));
				break;
			case BinObix.LIST:
				((List) obj).setMax((int) readIntVal(code));
				break;
			case BinObix.ABSTIME:
				((Abstime) obj).setMax(readAbstimeVal(code));
				break;
			case BinObix.RELTIME:
				((Reltime) obj).setMax(readReltimeVal(code));
				break;
			case BinObix.TIME:
				((Time) obj).setMax(readTimeVal(code));
				break;
			case BinObix.DATE:
				((Date) obj).setMax(readDateVal(code));
				break;
			default:
	...
	private boolean readBoolVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.BOOL_FALSE:
				return false;
			case BinObix.BOOL_TRUE:
				return true;
			default:
	...
	private double readRealVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.REAL_F4:
				return readFloat();
			case BinObix.REAL_F8:
				return readDouble();
			default:
	...
	private Abstime readAbstimeVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.ABSTIME_SEC:
				return new Abstime(readInt() * 1000L + Abstime.JAVA_2000);
			case BinObix.ABSTIME_NS:
				return new Abstime(readLong() / 1000000L + Abstime.JAVA_2000);
			default:
	...
	private Reltime readReltimeVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.RELTIME_SEC:
				return new Reltime(readInt() * 1000L);
			case BinObix.RELTIME_NS:
				return new Reltime(readLong() / 1000000L);
			default:
	...
	private Time readTimeVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.TIME_SEC:
				return new Time(readInt() * 1000L);
			case BinObix.TIME_NS:
				return new Time(readLong() / 1000000L);
			default:
	...
	private Date readDateVal(int code) throws IOException
	{
		switch (code & 0x3)
		{
			case BinObix.DATE_YYMD:
				return new Date(readUnsignedShort(), readUnsignedByte(), readUnsignedByte());
			default:
	...
	private Status readStatusVal(int code) throws IOException
	{
		switch (code & 0x7f)
		{
			case BinObix.STATUS_0 | BinObix.STATUS_0_DISABLED:
				return Status.disabled;
			case BinObix.STATUS_0 | BinObix.STATUS_0_FAULT:
				return Status.fault;
			case BinObix.STATUS_0 | BinObix.STATUS_0_DOWN:
				return Status.down;
			case BinObix.STATUS_0 | BinObix.STATUS_0_UNACKED_ALARM:
				return Status.unackedAlarm;
			case BinObix.STATUS_1 | BinObix.STATUS_1_ALARM:
				return Status.alarm;
			case BinObix.STATUS_1 | BinObix.STATUS_1_UNACKED:
				return Status.unacked;
			case BinObix.STATUS_1 | BinObix.STATUS_1_OVERRIDDEN:
