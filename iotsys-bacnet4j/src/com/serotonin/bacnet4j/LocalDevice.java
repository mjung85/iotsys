...
public class LocalDevice implements RequestHandler {
    ...
    public AcknowledgementService handleConfirmedRequest(Address from, Network network, byte invokeId,
        ...
        try {
            ...
            log.severe("Unsupported confirmed request: invokeId=" + invokeId + ", from=" + from + ", request="
    ...
    public AcknowledgementService setProperty(RemoteDevice d, ObjectIdentifier oid, PropertyIdentifier pid, Encodable value, UnsignedInteger priority)
            throws BACnetException {
        AcknowledgementService ack = send(d, new WritePropertyRequest(oid, pid, null, value, priority));
        return ack;
    }
