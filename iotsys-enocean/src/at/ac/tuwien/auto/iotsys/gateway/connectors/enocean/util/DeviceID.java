...
public class DeviceID {
    ...
    public DeviceID(long deviceIDAs32BitValue)
    {
    ...
    public static DeviceID fromByteArray (byte[] deviceID, int offset)
    {
    	byte[] devID = new byte[ID_LENGTH];
    	System.arraycopy(deviceID, offset, devID, 0, ID_LENGTH);
    	return fromByteArray(devID);
    }
    
    public static String toString(long deviceID)
    {
