...
import at.ac.tuwien.auto.iotsys.gateway.obix.objects.general.datapoint.impl.DPST_9_8_Impl;
...
public class DPST_9_8_ImplKnx extends DPST_9_8_Impl
{
	...
	public DPST_9_8_ImplKnx(KNXConnector connector, GroupAddress groupAddress, String name, String displayName, String display)
	{
...
//
//					log.fine("Temperature for " + DPST_9_8_ImplKnx.this.getHref() + " now " + x.getValueFloat(1));
