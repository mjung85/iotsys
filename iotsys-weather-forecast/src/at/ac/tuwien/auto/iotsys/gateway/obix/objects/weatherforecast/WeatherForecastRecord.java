...
public interface WeatherForecastRecord extends IObj {
	...
	public static final String probabilityCodeContract = "<enum name='probability-code' null='true' range='" + ProbabilityCodeImpl.CONTRACT + "'/>";
	...
	public static final String windSpeedContract = "<int name='wind-speed' min='0' max='12' null='true'/>";
	public Int windSpeed();

	public static final String symbolContract = "<enum name='symbol' null='true' range='iot:weatherSymbol'/>";//" + WeatherSymbolImpl.CONTRACT + "
	public Enum symbol();
}
